...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(size, material, options, promocode, result, formSelector, state) {
...
var stateCalc = function stateCalc(event, parameters, state) {
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_12__["postData"])(api, formData).then(function (res) {
        console.log(res);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not featch ".concat(url, ", status ").concat(res.status));
